...
const T = {
    en: {
        ...
        about_us: 'About Us', about_company: 'Softio', about_app_name: 'a2z Tech',
    ...
    ar: {
        ...
        about_us: 'من نحن', about_company: 'Softio', about_app_name: 'a2z Tech', about_version: 'الإصدار 1.0.2 Platinum',
...
let lang = localStorage.getItem('a2z_lang') || localStorage.getItem('generic_lang') || localStorage.getItem('panache_lang') || localStorage.getItem('otargi_lang') || 'en';
...
async function loadFeatureFlags() {
    try {
        ...
        if (currentUser) {
            ...
            sessionStorage.setItem('a2z_user', JSON.stringify(currentUser));
        }
    } catch {
...
function toggleLanguage() {
    lang = lang === 'en' ? 'ar' : 'en';
    localStorage.setItem('a2z_lang', lang);
    applyI18n();
    renderAll();
    updateSettingsLangLabel();
...
const scaleManager = {
    ...
    selectForWeighing(p) {
        ...
        // No hardware scale on a2z Tech main — prompt for kg
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const saved = sessionStorage.getItem('a2z_user') || sessionStorage.getItem('generic_user') || sessionStorage.getItem('panache_user') || sessionStorage.getItem('otargi_user');
        if (saved) {
            try {
