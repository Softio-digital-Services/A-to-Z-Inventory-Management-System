...
namespace InventorySystem
{
    ...
    public static class ThemeConfig
    {
        ...
        // BRANDING
        // ==========================================
        public static string CompanyName { get; set; } = "a2z Tech";
        public static string AppTitle { get; set; } = "a2z Tech";
        ...
        public static Color PrimaryColor { get; } = Color.FromArgb(56, 189, 248); // Light Blue #38BDF8
        public static Color PrimaryHoverColor { get; } = Color.FromArgb(14, 165, 233); // Sky Blue #0EA5E9

        // Gradient Colors for Primary Buttons
        public static Color GradientStart { get; } = Color.FromArgb(125, 211, 252); // Lighter Blue #7DD3FC
        public static Color GradientEnd { get; } = Color.FromArgb(56, 189, 248);   // Light Blue
        ...
        public static Color HeaderColor { get; } = Color.FromArgb(56, 189, 248);      
        ...
        public static Color POS_ChipActive { get; } = Color.FromArgb(56, 189, 248);
        public static Color POS_ChipActiveBorder { get; } = Color.FromArgb(14, 165, 233);
        ...
        private static Image GenerateNuriconFallback(string name)
        {
            try 
            {
                ...
                using (Graphics g = Graphics.FromImage(bmp))
                {
                    ...
                    if (name == "refresh") { c1 = Color.FromArgb(5, 205, 153); c2 = Color.FromArgb(56, 189, 248); }
                    ...
                    else if (name == "reports") { c1 = Color.FromArgb(56, 189, 248); c2 = Color.FromArgb(14, 165, 233); }
                    else if (name == "history" || name == "expenses") { c1 = Color.FromArgb(244, 63, 94); c2 = Color.FromArgb(225, 29, 72); }
                    else if (name == "quotations") { c1 = Color.FromArgb(56, 189, 248); c2 = Color.FromArgb(14, 165, 233); }
                    ...
                    else if (name == "accessories") { c1 = Color.FromArgb(56, 189, 248); c2 = Color.FromArgb(14, 165, 233); }
